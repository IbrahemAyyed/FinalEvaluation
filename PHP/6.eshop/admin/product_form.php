    ...
    if($_POST)
    {
        ...
        if(empty($msg_error))
        {
            if (!empty($_POST["id_product"])) //we register the update  
            {
                ...
                $result->bindValue(":id_product",$_POST['id_product'],PDO::PARAM_STR);
            }else{
...
?>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <select class="form-control" name="color" value = "<?= $color?>">
                <option disabled selected <?php if ($color=='$update_product'){echo'selected';}?> >Color of the product...</option>
        ...
        <div class="form-group">
            <select class="form-control" name="size" value = "<?= $size?>">
                ...
                <option <?php if ($size=='xs'){echo'selected';} {
                    # code...
                }?>>xs</option>
                <option <?php if ($size=='s'){echo'selected';} {
                    # code...
                }?>>s</option>
                <option <?php if ($size=='m'){echo'selected';} {
                    # code...
                }?>>m</option>
                <option <?php if ($size=='l'){echo'selected';} {
                    # code...
                }?>>l</option>
                <option <?php if ($size=='xl'){echo'selected';} {
                    # code...
                }?>>xl</option>
                <option <?php if ($size=='xxl'){echo'selected';} {
                    # code...
                }?>>xxl</option>
            </select>
        </div>
        <div class="form-group">
            <select class="form-control" name="gender">
                ...
                <option <?php if ($gender='u'){echo'selected';}?> value="u">Undefined</option>
            </select>
        </div>
        <div class="form-group">
